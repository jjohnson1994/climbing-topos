import { gradingSystems, cragTags, routeTags, areaTags, rockTypes, } from '@climbingtopos/globals';
import * as yup from 'yup';
export * as yup from 'yup';
export var NewCragSchema = function () {
    return yup
        .object()
        .shape({
...
export var UpdateCragSchema = function () {
    return yup
        .object()
        .shape({
        title: yup.string(),
        description: yup.string(),
        newTags: yup.array().of(yup.string().oneOf(cragTags)),
        removeTags: yup.array().of(yup.string().oneOf(cragTags)),
        latitude: yup
            .number()
            .typeError('Latitiude must be a number')
            .moreThan(-90, 'Latitude must be a valid latitude')
...
export var NewAreaSchema = function () {
    return yup
        .object()
        .shape({
        title: yup.string().required('Required'),
...
export var UpdateAreaSchema = function () {
    return yup
        .object()
        .shape({
        title: yup.string(),
...
export var NewTopoSchema = function () {
    return yup
        .object()
        .shape({
...
export var UpdateTopoSchema = function () {
    return yup
        .object()
        .shape({
...
export var NewRouteScheme = function () {
    return yup
        .object()
        .shape({
        title: yup.string().required('Required'),
...
export var UpdateRouteScheme = function () {
    return yup
        .object()
        .shape({
        title: yup.string(),
...
export var NewLogsSchema = function () {
    return yup
        .object()
        .shape({
        logs: yup.array().of(yup.object().shape({
            ...
            gradingSystem: yup.string().oneOf(gradingSystems.map(function (g) { return g.title; }), 'Invalid Grading System'),
...
export var NewListSchema = function () {
    return yup
        .object()
        .shape({
        title: yup.string().required('Required'),
...
export var UpdateListSchema = function () {
    return yup
        .object()
        .shape({
        routes: yup
