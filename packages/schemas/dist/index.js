...
exports.UpdateListSchema =
  exports.NewListSchema =
  exports.NewLogsSchema =
  exports.UpdateRouteScheme =
  exports.NewRouteScheme =
  exports.UpdateTopoSchema =
  exports.NewTopoSchema =
  exports.UpdateAreaSchema =
  exports.NewAreaSchema =
  exports.UpdateCragSchema =
  exports.NewCragSchema =
  exports.yup =
    void 0;
var globals_1 = require('@climbingtopos/globals');
var yup = require('yup');
...
var UpdateCragSchema = function () {
  return yup
    ...
    .shape({
      title: yup.string(),
      description: yup.string(),
      newTags: yup.array().of(yup.string().oneOf(globals_1.cragTags)),
      removeTags: yup.array().of(yup.string().oneOf(globals_1.cragTags)),
      latitude: yup
        .number()
        .typeError('Latitiude must be a number')
        .moreThan(-90, 'Latitude must be a valid latitude')
      ...
      logs: yup.array().of(
        yup.object().shape({
          ...
          gradingSystem: yup.string().oneOf(
            globals_1.gradingSystems.map(function (g) {
              return g.title;
            }),
