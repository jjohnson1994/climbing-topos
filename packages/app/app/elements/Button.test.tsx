...
describe("Button", () => {
  ...
  it("Renders an `icon`", () => {
    ...
    render(<Button icon={iconClass}>Button Text</Button>);
  ...
  it("Calls onClick When Clicked", () => {
    ...
    render(<Button onClick={fn}>Button Text</Button>);
  ...
  it("Adds `color` prop to `className`", () => {
    render(<Button color={Color.isWarning}>Button Text</Button>);
  ...
  it("Adds `is-loading` prop to `className`", () => {
    render(<Button loading={true}>Button Text</Button>);
