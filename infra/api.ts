...
api.route(
  'PATCH /areas/{areaSlug}',
  'packages/api/routes/areas/patch.handler',
  {
    auth: { iam: true },
  },
);
...
api.route(
  'PATCH /crags/{cragSlug}',
  'packages/api/routes/crags/patch.handler',
  {
    auth: { iam: true },
  },
);
...
api.route(
  ...
  'packages/api/routes/crags/items-awaiting-approval/get.handler',
  {
    auth: { iam: true },
  },
);
...
api.route(
  'PATCH /routes/{routeSlug}',
  'packages/api/routes/routes/patch.handler',
  {
    auth: { iam: true },
  },
);
...
api.route(
  'PATCH /topos/{topoSlug}',
  'packages/api/routes/topos/patch.handler',
  {
    auth: { iam: true },
  },
);
